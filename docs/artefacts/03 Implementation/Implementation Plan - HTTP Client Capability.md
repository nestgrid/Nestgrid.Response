...
Engineering Assurance is **Assured with conditions**. SEC-007, SEC-008 and SEC-009 are implemented or reconciled within the approved boundary and Security has closed them for the evaluated candidate. Protected publication, provenance and Release-stage decisions remain outside Engineering authority.

## SEC-009 evidence reconciliation outcome

Engineering refreshed the implementation evidence against source/evidence commit `8e9130693548c1799fcbfdbdfcbf7b4184d954b8`. The focused client suite contains 91 passing tests and the full solution contains 380 passing tests; coverage is 97.95% line and 95.90% branch, and mutation effectiveness is 90.85%. The locally packed package hash is `94dd1dbe24f0f1d08ca2783eee488ceb4e05892ab585150560696e71f0aa5484`, with package repository metadata pointing to the same evidence commit. Quality’s Q-HTTP-004 and Security’s SEC-009 are closed against this baseline; protected-CI provenance and final Release evidence remain required.
