...
The v0.8.0 additive HTTP client candidate has 366 passing solution tests, 97.85% package-owned line coverage and 90.08% mutation effectiveness. Quality recommends proceeding with the remaining Security, Platform and consumer conditions; Q-HTTP-003 is resolved by Engineering commit `f4d17a5`.
