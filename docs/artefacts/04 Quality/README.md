...
The v0.8.0 additive HTTP client candidate has 366 passing solution tests, 97.85% package-owned line coverage and 90.15% mutation effectiveness. Quality recommends proceeding with the remaining Engineering, Security, Platform and consumer conditions; the protocol-exception consistency finding remains open.
